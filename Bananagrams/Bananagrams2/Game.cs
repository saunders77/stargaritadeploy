...
namespace Bananagrams2
{
    public class Game
    {
        ...
        public Game(int gameNumber, string gameType, UpdateStatus hub)
        {
            InitializeWordList();
        ...
        private bool FormWordByStealing(Player guesser, string s)
        {
        ...
        private bool FormWordFromPool(Player guesser, string s)
        {
            int guesserNumber = GetPlayerNumber(guesser);
        ...
        public bool Guess(Player guesser, string s)
        {
    ...
    // TODO: stick this in another class
    public class Player
    {
